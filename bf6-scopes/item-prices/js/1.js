   ...
   methods: {
      ...
      itemInit() {
         const scopes = [
            ...
            { name: "ROX-1.50X", imgPath: "6-ROX-1_50X.png" },
            { name: "SU-231-1.50X", imgPath: "7-SU-231-1_50X.png" },
            { name: "1P87-1.50X", imgPath: "8-1P87-1_50X.png" },
            { name: "A-P2-1.75X", imgPath: "8-A-P2-1_75X.png" },
            { name: "RO-M-1.75X", imgPath: "9-RO-M-1_75X.png" },
            { name: "3VZR-1.75X", imgPath: "10-3VZR-1_75X.png" },
            { name: "CCO-2.00X", imgPath: "11-CCO-2_00X.png" },
            { name: "R4T-2.00X", imgPath: "12-R4T-2_00X.png" },
            { name: "BF-2M-2.50X", imgPath: "13-BF-2M-2_50X.png" },
            { name: "BAKER-3.00X", imgPath: "14-BAKER-3_00X.png" },
            { name: "SDO-3.50X", imgPath: "15-SDO-3_50X.png" },
            { name: "PVQ-31-4.00X", imgPath: "16-PVQ-31-4_00X.png" },
            { name: "LDS-4.50X", imgPath: "17-LDS-4_50X.png" },
            { name: "SD-PRISIM-5.00X", imgPath: "18-SD-PRISIM-5_00X.png" },
            { name: "R-MR-1.00X", imgPath: "2-R-MR-1_00X.png" },
            { name: "PAS-35-3.00X", imgPath: "22-PAS-35-3_00X.png" }
         ];
